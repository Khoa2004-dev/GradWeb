    ...
    <ScrollReveal>
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        <div className="rounded-3xl border border-[#8e6a43]/10 bg-white/50 backdrop-blur-xl p-5 xs:p-6 sm:p-12 shadow-[0_30px_90px_-42px_rgba(124,91,60,0.25)]">
          <h2 className="font-serif text-3xl font-semibold text-[#2a231d] text-center mb-8">
            Những Lời Tâm Sự
          </h2>

          <div className="space-y-6 text-center">
            <p className="font-serif text-base xs:text-lg sm:text-xl leading-loose text-[#3e3126]">
            ...
            <div className="pt-6 border-t border-[#8e6a43]/15">
              <p className="font-serif text-lg text-[#8f6a44] italic">
